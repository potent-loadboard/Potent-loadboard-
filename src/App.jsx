    ...
    <div style={{maxWidth:660,margin:'0 auto',padding:'12px 16px 60px',fontFamily:ff}}>
      ...
      {hasAccess?(
        ...
        <div style={{background:C.orange+'10',border:`2px solid ${C.orange}`,borderRadius:12,padding:'18px',textAlign:'center',marginBottom:16}}>
          ...
          <div style={{fontSize:12,color:C.dim,marginBottom:14,lineHeight:1.7}}>10 days FREE then $19.95/month. Cancel before trial ends and you won't be charged.</div>
          <Btn onClick={onNeedAccess} style={{padding:'11px 28px'}}>🎁 Start Free 10-Day Trial</Btn>
        </div>
      )}
...
function DriverSignup({onBack}){
  ...
  return(
    <div style={{maxWidth:460,margin:'0 auto',padding:'16px 16px 60px',fontFamily:ff}}>
      ...
      <div style={{fontSize:12,color:C.dim,marginBottom:20,lineHeight:1.7}}>10 days FREE then $19.95/month. See phone and email on every load. Cancel anytime before trial ends — no charge.</div>
      ...
      <Card style={{background:C.orange+'08',borderColor:C.orange+'44'}}>
        <div style={{fontSize:22,fontWeight:900,color:C.orange,textAlign:'center',marginBottom:4}}>🎁 10 Days FREE<br/>then $19.95/mo</div>
      ...
      <Btn onClick={subscribe} disabled={loading||!email} style={{width:'100%',padding:'13px',fontSize:14}}>
        {loading?'Redirecting...':"Start Free 10-Day Trial"}
      </Btn>
    </div>
  )
}
        ...
        <div style={{borderBottom:`1px solid ${C.border}`,paddingBottom:10,marginBottom:12}}>
          <div style={{display:'flex',gap:16,flexWrap:'wrap',alignItems:'center'}}>
            <div style={{fontSize:11,color:C.dim}}>
              ...
              Drivers get 10 days free then $19.95/mo.
